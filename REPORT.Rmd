...
Some of the technical analyist study candlestick pattern to try to predict the direction of the market, this field is known as candlestick pattern. It consist at knowing a set of patterns and the outcome of them.
...
In this section we will see what are the are the different datasets available. We will see what features are available to train the different models. Then we will prepare the data, verify it, and choose which machine learning algorithms we are going to train.
...
I choose this settings to have a dataset of around `r format(10000, big.mark = ",")` candles but also since Bitcoin ETF has been approved the market may have taken a different dynamic than the previous years.
