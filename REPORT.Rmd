...
Based on some shallow research on the press, we selected the following machine learnings algorithms that seems to work better with our type of dataset [@neuroquantology2023candlestick; @nakano2016stock]:
