...
```{r visual_analysis_candlestick_chart, cache=TRUE, echo=FALSE, message=FALSE, warning=FALSE}
...
p8
```
![BTC-USD Candlestick Chart (Last 24 Candles)](figures/visual_analysis_candlestick_chart)
...
```{r visual_analysis_ta, cache=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Technical analysis indicators of BTC-USD"}
