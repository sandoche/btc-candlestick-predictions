...
knitr::kable(head(candles_enhanced[na_indexes, ] %>% select(close, direction, hash_rate, avg_block_size, n_transactions, utxo_count, open, high, low, roc, macd, signal, rsi, mavg, pctB, value)), format = "simple", caption = "NAs of the dataset")
knitr::kable(tail(candles_enhanced[na_indexes, ] %>% select(close, direction, hash_rate, avg_block_size, n_transactions, utxo_count, open, high, low, roc, macd, signal, rsi, mavg, pctB, value)), format = "simple", caption = "NAs of the dataset")
```
...
knitr::kable(tail(candles_enhanced[na_indexes, ] %>% select(close, direction, hash_rate, avg_block_size, n_transactions, utxo_count, open, high, low, roc, macd, signal, rsi, mavg, pctB, value)), format = "simple", caption = "NAs of the dataset cleaned")
```
...
knitr::kable(results_candles, format = "simple", caption = "Model comparison for candles features")
```
...
knitr::kable(results_candles_fg, format = "simple", caption = "Model comparison for candles features and fear and greed index")
```
...
knitr::kable(results_candles_fg_chain, format = "simple", caption = "Model comparison for candles features, fear and greed index and chain data")
```
...
knitr::kable(results_candles_fg_chain_ta, format = "simple", caption = "Model comparison for candles features, fear and greed index, chain data and technical analysis indicators")
```
...
knitr::kable(top_models, format = "simple", caption = "Top models across all feature sets")
```
