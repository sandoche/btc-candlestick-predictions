...
results_candles_fg_chain <- evaluate_models("candles_fg", test_set)
...
summary_stats_candles_fg_chain
```
...
results_candles_fg_chain_ta <- evaluate_models("candles_fg", test_set)
...
summary_stats_candles_fg_chain_ta
```
