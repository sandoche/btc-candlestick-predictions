...
knitr::kable(head(candles_enhanced[na_indexes, ] %>% select(direction, hash_rate, avg_block_size, n_transactions, utxo_count, roc, macd, signal, rsi, mavg, pctB, value)), format = "simple", caption = "NAs of the dataset")
knitr::kable(tail(candles_enhanced[na_indexes, ] %>% select(direction, hash_rate, avg_block_size, n_transactions, utxo_count, roc, macd, signal, rsi, mavg, pctB, value)), format = "simple", caption = "NAs of the dataset")
```
...
knitr::kable(tail(candles_enhanced_cleaned[na_indexes, ] %>% select(direction, hash_rate, avg_block_size, n_transactions, utxo_count, roc, macd, signal, rsi, mavg, pctB, value)), format = "simple", caption = "NAs of the dataset cleaned")
```
...
knitr::kable(feature_set_summary, format = "simple", caption = "Summary of feature sets")
```
