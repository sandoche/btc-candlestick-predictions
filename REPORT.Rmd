...
As we can see the best models are the ones using random forest with 1 lag followed by the ones using 3 lags features.

We will use the following three models to fine tune, first trying to find the best number of lags, then using the fine tuning parameters.
...
Also it looks like the models with less features perform better.
